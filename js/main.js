...
import { CustomGameEditor } from './ui/CustomGameEditor.js';
...
import { GAME_CONFIG, BUILD_VERSION } from './config/gameConfig.js?v=20260710n';
...
try {
  ...
  hud = new HUD(game);
  customGameEditor = new CustomGameEditor(game);
  game.customGameEditor = customGameEditor;
